...
export const metadata: Metadata = {
  title: "Instant-downloader | Terms & Conditions",
};

export default function TermsAndConditionsPage() {
  return (
    <main className="py-16 w-full gap-3 mx-auto flex flex-col items-center justify-center text-center">
      <div className="mt-6 flex justify-center items-center flex-col ">
        <h1 className="text-2xl text-clip font-black sm:text-3xl lg:text-5xl xl:text-6xl">
          Terms
          <span className="mx-2 text-blue-600 sm:mx-3 lg:mx-4">&</span>
          conditions
        </h1>
        <div className="w-11/12 p-4 mt-2 sm:mt-4 sm:w-5/6 lg:w-4/5 xl:w-3/4">
          <div className="text-sm text-left sm:text-base lg:text-lg xl:text-lg">
            Please review these terms and conditions of use carefully before
            using Instant-downloader
          </div>
          <div className="text-sm text-left mt-2 sm:text-base lg:text-lg xl:text-lg">
            {
              'This document states the terms and conditions ("Terms") upon which Instant-downloader ("we" or "us") will provide service to you on its websites, including, without limitation, the above listed websites (collectively, the "Website"). These Terms constitute a contractual agreement between you and us. By visiting, accessing, using, and/or joining (collectively "using") the Website, you express your understanding and acceptance of these Terms. As used in this document, the terms "you" or "your" refers to you, any entity you represent, your or its representatives, successors, assigns and affiliates, and any of your or their devices. If you do not agree to be bound by these Terms, navigate away from the Website and cease using it.'
            }
          </div>
        </div>
      </div>
      <>
        <div className="w-11/12 p-4 flex justify-center items-start flex-col sm:w-5/6 lg:w-4/5 xl:w-3/4">
          <h3 className="text-base font-semibold sm:text-base lg:text-lg xl:text-xl">
            1. Eligibility
          </h3>
          <div className="mt-4 flex flex-col gap-2">
            <div className="text-sm text-left sm:text-base lg:text-lg">
              {
          ...
          <div className="mt-4 flex flex-col gap-2">
            ...
            <div className="text-sm text-left sm:text-base lg:text-lg">
              ...
              <ul className="ml-6">
                <li>
                  {
                    "1. You agree not to use the Website for any unlawful purpose or in any way that is prohibited by these Terms, and accept not to download any Copyright content without permission from the rightful owners;"
                  }
                </li>
                <li>
                  {
                ...
                <li>
                  {
                    "5. You agree not to forge headers or otherwise manipulate identifiers in order to disguise the origin of any information you transmit;"
                  }
                </li>
                <li>
                  {
                    "6. You agree not to use any automated means, including robots, crawlers or data mining tools, to download, monitor or use data or Content from the Website;"
                  }
                </li>
                <li>
                  {
                    "7. You agree not to take any action that imposes, or may impose, in our sole discretion, an unreasonable or disproportionately large load on our technology infrastructure or otherwise make excessive demands on it;"
                  }
                </li>
                <li>
                  {
                    '8. You agree not to "stalk" or otherwise harass anyone on or through the Website;'
                  }
                </li>
                <li>
                  {
                    "9. You agree not to disable, circumvent, or otherwise interfere with security related features of the Website or features that prevent or restrict use or copying of any content or which enforce limitations on the use of the Website or the content therein;"
                  }
                </li>
                <li>
                  {
                    "10. You agree not to post, link to, or otherwise make available on the Website any material that contains software viruses or any computer code, file or program designed to interrupt, destroy, limit or monitor the functionality of any computer software or hardware or any telecommunications equipment;"
                  }
                </li>
                <li>
                  {
                    "11. You agree not to license, sublicense, sell, resell, transfer, assign, distribute or otherwise in any way commercially exploit or make available the Website or any Content to any third party;"
                  }
                </li>
                <li>
                  {'12. You agree not to "frame" or "mirror" the Website; and'}
                </li>
                <li>
                  {
        ...
        <div className="w-11/12 p-4 flex justify-center items-start flex-col sm:w-5/6 lg:w-4/5 xl:w-3/4">
          ...
          <div className="mt-4 flex flex-col gap-2">
            ...
            <div className="text-sm text-left sm:text-base lg:text-lg">
              {
                "b.) Although we are not subject to United States law, we voluntarily comply with the Digital Millennium Copyright Act. Pursuant to Title 17, Section 512(c)(2) of the United States Code, if you believe that any of your copyrighted material is being infringed on the Website, you may sent us a notice through"
              }
              <Link
                href={"/#"}
                className="mx-1 leading-4 text-blue-400 hover:text-blue-500 hover:border-b hover:border-b-blue-500"
              >
                this link.
              </Link>
            </div>
